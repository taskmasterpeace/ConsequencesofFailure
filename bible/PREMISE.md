...
>
> Dark, suspenseful, and sometimes satirical. **There are no traditional supervillains** — the Greys only chose people of sound mind; the antagonist is human nature and the systems people build. Set during the **8 years preceding an alien invasion by an armada of four horrific alien lifeforms.**
...
- **SPEAR vs FIST:** Vaughn Galloway's *vision* is **SPEAR** — an international LSW team uniting all nations against the coming threat. The **UN rejects it**, so he builds the **US-only fallback, FIST**. SPEAR is never created; Galloway calls the rejection "the worst mistake in human history."
- **Rusty Richards** = the **non-powered herald**, later called **"the Tomorrow Man."** He rallies world leaders to take the threat seriously; he does **not** command or organize LSWs.
- **Creator:** Robert "Task" Smith — Machine Kings Media.

## ⚠️ CANON vs ABANDONED DRAFT (do not confuse)
