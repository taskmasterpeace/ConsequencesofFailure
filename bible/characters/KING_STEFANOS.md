# KING STEFANOS — Alexandr Stefanos  `[canon revision — creator, 2026-06-26]`

**One-line:** Greece's beloved pacifist President and **the world's first celebrity superweapon** — until blood-hunters come for his pregnant wife, and the peacemaker becomes something terrible.

> Supersedes parts of the original `canon/characters/King Stefanos.txt` (the grand "city-leveling Superhero King / weeks-long Turkey bombing / razes DC" scale is **pulled back** per the creator). Power, wife, and the assassin are re-cut below. Flags for reconciliation in the last section.
...
- **The Jackal = Sandra** — white American, **"the L.A. Jackal,"** bearer of the **sentient ring ("Its Voice").** She races to be **first** to Marletta because the ring tells her she alone can do a **clean extraction where the victim survives** — no kidnap-doctor-recovery butchery. She breaks into Marletta's Athens condo, sedates her, begins the operation — and **something goes wrong** `[climax to design — options in the report]`.
- **When:** `[TBD — but EARLY]`. He's **the first celebrity superweapon**, and his fall makes him **the first LSW the world brands a villain / war criminal / fugitive** — a precedent-setting landmark; place it early on the master timeline.
- **The fall — "the 4 days."** After the assassination he locks away 8 days, then gives a **chilling live TV speech** (Homelander-style charisma turned terrifying — *Turkey must pay; they will burn*) and **walks out of the press conference straight into the attack.** He levels Turkish targets **all night, comes home, goes out again** — for **three days; on the 4th day they finally bring a response.** Four days, countless dead. *(His power is human-scale per shot — craters, structures — but relentless over four days = devastation. This reconciles "pulled-back power" with mass destruction.)*
- **Why it's a war crime → the first villain:** under the **Living Super Weapon Threshold Treaty**, **governments may NOT wield LSWs** — only companies (the workaround everyone uses). A *head of state* personally waging LSW war on another nation is the treaty's ultimate violation → the world brands him a war criminal; the US/UN launch a global manhunt.
- **"Wears Marletta's face":** ✅ he acquires **shapeshifting** (per the original — synthesized from a shapeshifter's cerebral fluid) and, in grief, **takes his dead wife's face.**
