...
| Joker | **"Tally"** (forensic accountant) | Tastes lies; going blind as the price; his teenage daughter has started lying to him. |
| Joker | **"Pallet" / Yelena Marsh** (combat nurse) | Edits pain with her hands — but the pain "lays away" and comes due; the only Wildcard who's asked to be switched off. |
| Joker | **"Presser" / Tomas** | Projects a fear-killing field; it's numbing *him* into a contented flat-line. Charles has refused to be in a room with him three times. |

## The five fault lines (the engine)
1. **The Secret War** — who knows Deck 52 is a vendetta vs who believes the clean-PMC story (Pierce holds the secret).
2. **Machines vs Men** — Cho automating the company vs Kané's soldiers & Vance's people, who'd be made obsolete or monstrous.
3. **The Wildcard Question** — the Initiative's ethics: Vance (consent-from-the-desperate isn't consent) vs Cho & Pierce (who *wrote* the consent framework and lies awake about it).
...
- Confirm the **Maddox = surviving Wildcard who serves as both Cho's proof and Vance's warning** conceit — it's a strong hinge if you want it.
