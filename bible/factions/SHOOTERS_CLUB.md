# THE SHOOTER'S CLUB  `[canon capture — from "Condemned"]`

The grounded, **no-powers** floor of the COF world: a prestige police-corruption tragedy. Story: `prose/shooters-club/CONDEMNED.md`.

## What "Condemned" establishes
- The **Shooter's Club** is an elite LAPD anti-gang unit (the *Times'* nickname) led by **Sgt. Eugene "Gene" Bonny**. Publicly the most effective gun-seizing unit in the city; secretly running a **ghost-gun skim** out of "the Range" (a sub-basement gunsmithing shop + furnace): they log seized guns as "unserviceable," melt only the serialized part for the state inspector, and **resurrect the untracked parts onto blank frames** → untraceable guns sold to the cartel.
- **Why Gene does it:** his daughter **Maddie's** catastrophic illness and its crushing medical debt. "The condemned arithmetic" — he'd make every move again.
- **Rob Holt** — Gene's protégé/surrogate son (haunted by a partner who bled out in "eleven minutes"). His tragedy: *loyalty to the man, not the plan.* Breaks the rules out of love, hands the unit to the cartel, kills informant **Eddie Pruitt**, and ultimately **wires up and flips** — but Gene takes the whole fall on tape to save him.
- **Dawn Petrakis** — IA sergeant who only hunts "guns the system swore were dead" (her brother was killed by one). The patient nemesis; goes *around* the chain of command to a federal prosecutor (**Linda Soh**).
- **Chief Vernon Acker** — clean for 30 years until he buries his son **Tyler's** ghost-gun arrest; Gene leverages that ("the corner is the safest place in the room").
...
## 🔒 COP NAMES — LOCKED
- **Officer Headly** — the cop who **fires the fatal shot** that kills Tyrell Lober, and who **later commits suicide.** (Spelling: **Headly.**) This suicide is the thread's heaviest beat.
- **Officer Timothy Oliver** — the **cover-up** cop (plants the gun, coaches the story). **NOT a Shooter's Club member; NOT a recurring/throughline character.**
- *(From the produced film: the "weapon" was a **drone/game controller**; sister **Janine Lober** = museum curator; IA detective **Deborah Winston** breaks the cover-up.)*
...
## `[DRAFT]` Chapter 2 material — from the 2026-06-26 brain-dump (Thread D)
`Source: prose/shooters-club/CHAPTER_2.md` — an **unreconciled alternate/earlier treatment** of the Shooter's Club. **Not canon; conflicts with CONDEMNED (see below).** New plot beats this draft introduces:

- **The unit doesn't just skim guns — it *fans a gang war.*** Gene Bonny + Rob Holt work from a **surveillance hub** and deliberately engineer a war between two gangs, **GSG** and the **TTS Boys** — sending **anonymous tips to rival gangs** to keep the violence (and the gun appetite) burning. Theme line: *"cops by day, puppet masters by night… break the city to save it."*
...
1. **Two Shooter's Club origins exist.** "Condemned" = Gene Bonny / ghost-gun skim / Chief **Acker**. The earlier `Stampede.txt` version = corrupt LAPD gun-trafficking unit, **Dave Wilkerson**, Chief **Doug Allen**, the murder of **Rebecca Carranza** (which creates **Stampede/John Rivers**). These don't match. Is **Condemned the definitive Shooter's Club**, with the Stampede version revised to fit (or a separate crime within the same rotten unit)? Does **Stampede/John Rivers still connect** to this?
2. **Cartel name/boss:** "Cuatro Dedos" + boss **Diego Rivera** (Condemned) vs "Cuatros Dedos" + **Eduardo Cuatros** (Jance Bloomberg). Pick one spelling + reconcile the boss (succession? same era?).
3. **Reyes name load:** Maddie's *Dr. Reyes*, patrolman *Reyes* (lampshaded), and *Dana Reyes* (the Deck 52 burned woman). Consider varying one.
